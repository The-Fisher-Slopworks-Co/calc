...
const en = {
  ...
  "payment.error.back": "Back to plans",
  "usage.label": "Usage",
  "usage.limitReached": "Monthly calculation limit reached.",
...
const ru: Record<TranslationKey, string> = {
  ...
  "payment.done": "Готово!",
  "payment.error.insufficient": "Недостаточно средств",
  "payment.error.back": "К тарифам",
  "usage.label": "Использование",
  "usage.limitReached": "Достигнут месячный лимит вычислений.",
